...
// <<< Don't Change
    ...
    /*
    public static class CountWordComparator implements Comparator<Pair<Integer, String>> {

        @override
        public int compare(Pair<Integer, String> left, Pair<Integer, String> right) {
            Integer leftInteger = left.first;
            Integer rightInteger = right.first;
            Integer difference = rightInteger - leftInteger;
            if ( difference != 0 ) {
                return difference;
            }
